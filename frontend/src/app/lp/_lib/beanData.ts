...
export const beans: BeanDetail[] = [
  ...
  },
  {
    ...
    detailDescription:
      "ラズベリーのような華やかな香り。熟度の良い華やかさがありハチミツのような優しい甘みしっとりとした余韻が続きます。\n\n【どんなコーヒー？】\nホンジュラスは中米の山岳国で、18〜19世紀にコーヒー栽培が始まり、20世紀に入って輸出産業として本格化しました。近年は品質改善と市場開拓が進み、中米最大級のコーヒー輸出国として成長。国際品評会Cup of Excellence（COE）でも入賞ロットが高く評価され、スペシャルティ産地としての認知が高まっています。\n\nホンジュラスの中でも1800mという標高はかなり高い部類に入ります。高い標高では夜間の気温がぐっと下がるため、コーヒーの実がゆっくりと時間をかけて熟します。その結果、豆の密度（硬度）が高まり、味わいがギュッと凝縮され、複雑な酸味とコクが生まれます。",
    origin: "ラパス県テパングアレ エリア",
    farm: "ウエヴォ・デ・オロ農園",
    roastLevel: "中深煎り",
    processing: "ウォッシュド",
